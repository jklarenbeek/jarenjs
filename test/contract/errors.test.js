...
describe('contract errors — the code table', () => {
  it('lists the compile, projection, host, http, client and port/local codes with one-line meanings, frozen', () => {
    ...
    assert.deepStrictEqual(codes, [...range(1, 21), ...range(60, 61), ...range(1001, 1014), ...range(2001, 2015), ...range(2050, 2058), ...range(2070, 2074), ...range(2090, 2097), 'JC2110', ...range(2120, 2124)]);
