// Generated by @jarenjs/contract's TypeScript projection from
...
export interface DocPutInput {
  id: string;
  doc: Array<{ [key: string]: unknown; }>;
  dry?: boolean;
  [key: string]: unknown;
}


export type DocPutOutput = unknown;

export interface DocRemoveInput {
  id: string;
  [key: string]: unknown;
}
...
export interface Operations {
  ...
  'doc.remove': { kind: 'command'; input: DocRemoveInput; output: DocRemoveOutput; errors: never };
}

/** Every public operation by id — opaque ones included — with its input type, for `Client.url`. */
export interface UrlOperations {
  'doc.put': DocPutInput;
  'doc.remove': DocRemoveInput;
}
