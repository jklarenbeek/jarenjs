...
The table below scopes the original physical SQLite adoption applications.
Managed SQLite/PostgreSQL application composition now has a separate
[capability, executable and recovery matrix](../packages/db/docs/POSTGRESQL.md).
It does not migrate these adopted physical files or retire their SQL automatically.
...
|---|---|---:|---:|---:|---:|---:|---:|
| node | catalog | 10000 | 748.28 | 351.61 | 63.58 | 272.29 | 0 |
| node | archive-stock | 75000 | 3954.15 | 2585.71 | 376.78 | 860.66 | 0 |
| bun | catalog | 10000 | 639.75 | 286.49 | 84.19 | 287.48 | 0 |
| bun | archive-stock | 75000 | 3100.36 | 1953.59 | 321.04 | 968.05 | 0 |
...
The [memory observation history](../benchmark/adoption-memory-history.json)
retains an earlier Bun archive-stock peak-RSS loss of 1,413,287,936 bytes against
the unchanged 1,073,741,824-byte ceiling. An unchanged-source repeat measured
999,518,208 bytes; two runs after serializing Store setup measured 1,019,547,648
and 1,012,097,024 bytes. Every workload runs in a fresh child, excluding carryover
of the catalog process's high-water mark. The assertion instrument retains full
rows, search membership and preview copies, so these values are broader than
library-only allocation. The unchanged-source pass prevents attributing the
...
| catalog | search.startupMs | 15000 | 372.60 (pass) | lexical: 414.33 (pass) | 351.61 (pass) | 286.49 (pass) |
...
| catalog | resources.sampledHeapBytes | 268435456 | 154179328 (pass) | —: pending | 66673224 (pass) | 88278881 (pass) |
| catalog | resources.peakRssBytes | 536870912 | 315109376 (pass) | —: pending | 285511680 (pass) | 301449216 (pass) |
| catalog | resources.peakHeapBytes | 268435456 | pending | —: pending | pending | pending |
| catalog | resources.teardownMs | 1000 | 0.07 (pass) | —: pending | 0.19 (pass) | 0.33 (pass) |
...
| archive-stock | search.startupMs | 45000 | 2096.09 (pass) | lexical: 3022.10 (pass) | 2585.71 (pass) | 1953.59 (pass) |
...
| archive-stock | resources.sampledHeapBytes | 805306368 | 1020055816 (fail) | —: pending | 395080008 (pass) | 336634941 (pass) |
| archive-stock | resources.peakRssBytes | 1073741824 | 1209151488 (fail) | —: pending | 902463488 (pass) | 1015078912 (pass) |
| archive-stock | resources.peakHeapBytes | 805306368 | pending | —: pending | pending | pending |
| archive-stock | resources.teardownMs | 2000 | 0.10 (pass) | —: pending | 0.20 (pass) | 0.32 (pass) |
