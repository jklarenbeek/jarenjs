...
flowchart BT
    ...
    CONTRACT["@jarenjs/contract<br/>operation contracts: validators,<br/>path matcher, http/local/port bindings,<br/>projections, revision, diff"]
