...
`@jarenjs/linq/contract` builds to **<!--fact:bundle.contract-->45,371<!--/fact--> bytes** as a minified,
...
- **the schema pen is included, and that is the ceiling.** A contract's
  ...
  the bundle carries <!--fact:bundle.schema-->33,156<!--/fact--> of its <!--fact:bundle.contract-->45,371<!--/fact--> bytes as the schema pen's own.
