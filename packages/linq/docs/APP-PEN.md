...
`@jarenjs/linq/app` builds to **<!--fact:bundle.app-->46,934<!--/fact--> bytes** as a minified,
...
side by side: `@jarenjs/linq/schema` <!--fact:bundle.schema-->32,499<!--/fact--> bytes,
`@jarenjs/linq/jslt` <!--fact:bundle.jslt-->19,196<!--/fact-->, `@jarenjs/linq/app` <!--fact:bundle.app-->46,934<!--/fact-->. The subpath sums do not add — all
