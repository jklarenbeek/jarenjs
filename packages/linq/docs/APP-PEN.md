...
`@jarenjs/linq/app` builds to **<!--fact:bundle.app-->51,084<!--/fact--> bytes** as a minified,
...
side by side: `@jarenjs/linq/schema` <!--fact:bundle.schema-->36,795<!--/fact--> bytes,
`@jarenjs/linq/jslt` <!--fact:bundle.jslt-->19,934<!--/fact-->, `@jarenjs/linq/app` <!--fact:bundle.app-->51,084<!--/fact-->. The subpath sums do not add — all
