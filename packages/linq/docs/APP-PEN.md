...
`@jarenjs/linq/app` builds to **<!--fact:bundle.app-->47,593<!--/fact--> bytes** as a minified,
...
`@jarenjs/linq/jslt` <!--fact:bundle.jslt-->19,856<!--/fact-->, `@jarenjs/linq/app` <!--fact:bundle.app-->47,593<!--/fact-->. The subpath sums do not add — all
