...
`@jarenjs/linq/app` builds to **<!--fact:bundle.app-->47,535<!--/fact--> bytes** as a minified,
...
side by side: `@jarenjs/linq/schema` <!--fact:bundle.schema-->33,098<!--/fact--> bytes,
`@jarenjs/linq/jslt` <!--fact:bundle.jslt-->19,798<!--/fact-->, `@jarenjs/linq/app` <!--fact:bundle.app-->47,535<!--/fact-->. The subpath sums do not add — all
