...
`@jarenjs/linq/forms` builds to **<!--fact:bundle.forms-->37,254<!--/fact--> bytes** as a minified,
...
is <!--fact:bundle.schema-->33,098<!--/fact--> bytes, so the whole `x-form` vocabulary — the mixin, the rule
