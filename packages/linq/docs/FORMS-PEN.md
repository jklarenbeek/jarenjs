...
`@jarenjs/linq/forms` builds to **<!--fact:bundle.forms-->40,951<!--/fact--> bytes** as a minified,
...
is <!--fact:bundle.schema-->36,795<!--/fact--> bytes, so the whole `x-form` vocabulary — the mixin, the rule
