...
export const HOME_CONTENT = {
  ...
  engines: [
    ...
    { key: 'db', title: 'Data', blurb: 'Documents in SQLite behind driver and dialect seams: model-declared collections with generated-column indexes, a pushdown planner that renders guarded parameter-bound SQL and reports its residuals through explain(), a safe profile for untrusted query documents, and migrations as diffable, shadow-validated documents.', perf: 'the pushed plan answers 56.7× faster than the same query forced to the residual (5k docs, measured)' },
