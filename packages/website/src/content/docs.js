...
export const DOCS_SECTIONS = [
  ...
  },
  {
    ...
    blocks: [
      p('XQuery 3.1 semantics — FLWOR, joins, grouping, quantifiers, an 83-operator library — as JSON documents with JSONPath leaves. The grammar is published as JSON Schema, so a constrained decoder cannot emit an invalid query.'),
