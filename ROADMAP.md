...
- [ ] **Real-browser accessibility and lifecycle matrix** — the dialog/focus/keyboard/teardown contracts of APP-FORMAT §8.4/§8.5 are tested headlessly; a Chromium/Firefox/WebKit CI matrix (plus the website keyboard/screen-reader audit) is the remaining open item — real-browser coverage is claimed nowhere until it exists.
